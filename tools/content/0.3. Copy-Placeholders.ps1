...
param(
    [string[]]$PathMap = @(
        "true=/sitecore/layout/Placeholder Settings/Project/Common=/sitecore/layout/Placeholder Settings/Project/Zont/Habitat"
...
Write-Output "`nCopying PLACEHOLDERS...`n"
