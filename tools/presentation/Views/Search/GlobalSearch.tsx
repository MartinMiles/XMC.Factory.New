  ...
  return (
    <>
      ...
      <li className="navbar-activity-search dropdown">
          ...
          <a href="#" className="btn navbar-toggle-search" data-toggle-className="is-searching" data-target="#mainNavbar">
          ...
          <div className="dropdown-menu dropdown-menu-wide" id="navbar-activity-search-results">
              ...
              <div className="row">
                  <div className="col-md-12">
                      <button className="btn btn-primary btn-sm pull-right" onclick="$('.navbar-activity-search form').submit()">Search</button>
                  </div>
              </div>
          </div>
      </li>
