...
const 1Column = (props: ComponentProps): JSX.Element => {
  return (
    <>
      ...
      <div className="thumbnail">
        <a href="http://habitat.dev.local/en/About-Habitat/Introduction">
          <img src="/-/media/Habitat/Images/Square/Habitat-067-square.jpg?h=500&amp;mw=500&amp;w=500&amp;hash=A070A749EEDBB0F49F3D25AD837C9BBC" className="img-responsive" alt="" width="500" height="500" DisableWebEdit="False" />
        </a>
      ...
      <p>The solution is built on the Sitecore Helix guidelines, which&nbsp;<span>focuses on increasing productivity and quality in Sitecore projects</span>.</p>
          </p>
          <a href="http://habitat.dev.local/en/About-Habitat/Introduction" className="btn btn-default">
                  Read more
          </a>
        </div>
      </div>
